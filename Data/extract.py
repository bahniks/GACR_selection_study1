...
columns = {"Login": ("id", "BDM1", "BDM2", "condition"),
           ...
           "BDM Control Questions": ("question", "answer"),
           "BDM": ("block", "bid"),
           "Cheating 3": ("id", "block", "trial", "version", "condition", "roll", "prediction", "report", "reward", "charity", "time", "time1", "time2"), 
           "Auction Control Questions": ("question", "answer"),
           "Auction": ("block", "bid", "prediction"),
           ...
           "Lottery": ("id", "choice1", "choice2", "choice3", "choice4", "choice5"),
